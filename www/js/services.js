...
/// need conection to update with firebase database !
	.config(function () {
		var fire = {
			apiKey: "AIzaSyDzfusrzA_QIJB6SsTIILmi2mTQTewt2p0",
			authDomain: "educaper-1386.firebaseapp.com",
			databaseURL: "https://educaper-1386.firebaseio.com",
			storageBucket: "educaper-1386.appspot.com",
		};
		firebase.initializeApp(fire);
	})

	.factory('mCourses', function ($firebaseArray) {
	...
	.factory('mTeachers', function () {
		var coursesRef = firebase.database().ref().child('Teachers');
	})

	.factory('mUsers', function () {
		var USERS = [
			{
				id: 12,
				name: "Mounir",
				thumb: "http://api.randomuser.me/portraits/thumb/men/4.jpg",
				role: "Education Expert"
			},
			{
				id: 18,
				name: "Abdullah",
				thumb: "http://api.randomuser.me/portraits/thumb/men/14.jpg",
				role: "Department Deen"
			},
			{
				id: 20,
				name: "Imad",
				thumb: "http://api.randomuser.me/portraits/thumb/men/7.jpg",
				role: "Instructor"
			},
			{
				id: 16,
				name: "Benzima",
				thumb: "http://api.randomuser.me/portraits/thumb/men/12.jpg",
				role: "Student"
			}
		];
