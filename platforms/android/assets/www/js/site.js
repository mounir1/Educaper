angular.module('mm.site', [])
    ...
    .factory('mmSiteCourses', function (mCourses) {
    ...
    .controller('mmSiteCourses', function (mmAuth, $rootScope, $scope, mmSiteCourses) {
        console.log("$rootScope.Educaper  " + $rootScope.Educaper);
        $scope.User = mmAuth.getCurrentUser();
        if ($rootScope.Educaper === true) {
