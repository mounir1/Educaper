angular.module('app.uirouts', ['pascalprecht.translate'])
    .config(function ($stateProvider, $urlRouterProvider, $translateProvider, $provide, $ionicConfigProvider) {
        ...
        $mmStateProvider
            ...
            .state('site.teachers', {
                ...
                views: {
                    'site': {
                        controller: 'mmTeachersCtrl',
                        templateUrl: 'tpl/site-teachers.html',
                        resolve: {
                            discussions: function (mmMessages) {
                                return mmMessages.getDiscussions();
                            },
            ...
            .state('site.students', {
                ...
                views: {
                    'site': {
                        controller: 'mmTeachersCtrl',
                        templateUrl: 'tpl/site-students.html',
                        resolve: {
                            discussions: function (mmMessages) {
                                return mmMessages.getDiscussions();
                            },
            ...
            .state('site.teachers-contact', {
                tablet: {
                    parent: 'site.teachers',
                    node: 'contacts-tablet'
                },
                url: '/teachers-contact/:index',
                views: {
                    'site': {
                        controller: 'mmteacherEvalCtrl',
                        templateUrl: 'tpl/teacher-eval.html',
                        resolve: {
                            /*courses : function(mCourses){
                            	return mCourses.all;
                            },*/
            ...
            .state('site.teachers-charts', {
                tablet: {
                    parent: 'site.teachers.contacts-tablet',
                    node: 'charts-tablet'
                },
                url: '/teachers-charts/:ID',
                reload: true,
                views: {
                    'site': {
                        controller: 'mmteacherchartsCtrl',
                        templateUrl: 'tpl/teacher-charts.html',
                        resolve: {
                            contact: function ($stateParams, mmMessages) {
                                return mmMessages.getContact($stateParams.index);
                            },
            ...
            .state('site.teacher-charts', {
                tablet: 'site.teachers-charts',
                url: '/teachers-charts/:ID',
                reload: true,
                views: {
                    'site': {
                        controller: 'mmChartCtrl',
                        templateUrl: 'tpl/site-chart.html',
                        resolve: {
